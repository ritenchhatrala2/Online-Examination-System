    ...
    online test
            ...
            <form id="summary" action="viewresult.php" method="post">
              ...
              ?>
                        ...
                        <li><input type="submit" value="Back" name="back" class="btn" title="View Results"/>&nbsp;&nbsp;&nbsp;</li>
                        <?php
                        }
                        else
                        {
         ...
         <center>                       
           <table width="940">
                        ...
                        <tr>
                            <td height="35" colspan="2" ><hr style="color:#ff0000;border-width:2px;"/></td>
                        </tr>
                         <tr>
                    ...
                    <table width="940">
                        ...
                        <tr>
                            ...
                            <td><?php echo htmlspecialchars_decode($r2['stdans'],ENT_QUOTES);
							if($r2['stdans']=="unanswered")
               ...
               <hr />
                     <div id="piechart" style="width: 900px; height: 500px;">
                            ...
                            //editing components
                                ?>
  <center><h2>View Result</h2><hr /><br /></center>                              
                    <table width="940">
                        <tr bgcolor="#0099FF">
                            <th>Date and Time</th>
                            <th>Test Name</th>
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ...
          ['Unanswered',<?php echo $unanswered; ?>],
          ]);
