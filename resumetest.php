...
// Navigations
    ...
    if(isset($_REQUEST['resume'])) {
        echo "<div class=\"pmsg\" style=\"text-align:center;\">  </div>";
    }
    else {
    ...
    ?>
                        ...
                        if(isset($_REQUEST['resume'])|| $display==true) {
                            ?>
                   <center><h2>Resume Test <font color="#1A8CCE" face="Comic Sans MS, cursive"><?php echo $_SESSION['testname']; ?></font></h2><hr><br>
                    <table>
                        <tr>
                        ...
                        <tr>
                            <td colspan="3">
                                <br/><center><input type="submit" tabindex="3" value="Resume Test" name="resumetest" class="btn" /></center><br/>
                            </td>
                        </tr>
                    </table>
</center>
    ...
    <?php
        ...
        //editing components
            ?>
            	<center><h2>Resume Test</h2><hr><br></center>
                    <table width="940">
                        <tr>
                            <th>Date and Time</th>
                            <th>Test</th>
