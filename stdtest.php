    ...
    online test
            ...
            <form id="stdtest" action="stdtest.php" method="post">
                <div class="menubar">
                    ...
                    ?>
                                <center>
                                <h2>Enter Code to start Test</h2><hr /><br />
                                <table>
                                    <tr>
                                    ...
                                    <tr>
                                        <td colspan="3">
                                            <center><input type="button" tabindex="3" value="Start Test" name="starttest" class="btn" onclick="openWin()"/></center>
                                        </td>
                                    </tr>
                                </table></center>
...
function openWin()
{
var myWindow = window.open("testconducter.php","abc","width=900,height=600");
}
</script>
                    ...
                    <?php
                                ...
                                if (mysql_num_rows($result) == 0) {
                                    ...
                                    //editing components
                    ?><center><h2>Take Test</h2><hr /><br /></center>
                                    <table width="940">
                                        <tr>
                                            <th>Test Name</th>
